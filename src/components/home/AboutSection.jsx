        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <SlideUp className="flex flex-col items-start text-left">
            ...
            <p className="text-white/70 text-sm md:text-base font-sans font-light leading-relaxed mb-6">
              Hindustan Buildwell has established itself as one of the premier luxury corporate developers in India. For over a decade, we have created architectural masterpieces that elegantly balance futuristic design, zero-emission sustainability, and structural integrity.
            </p>
