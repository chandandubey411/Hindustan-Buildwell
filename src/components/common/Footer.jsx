    ...
    <footer className="relative bg-dark pt-20 pb-8 border-t border-white/5 font-heading z-10 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8">
          ...
          <div className="flex flex-col gap-6">
            ...
            <ul className="flex flex-col gap-4 text-sm text-white/70 font-sans font-light">
              <li className="flex gap-3">
                ...
                <span>45, The Courtyard, Maharishi Ashram Marg, Sector 107, Noida, U.P. - 201304, INDIA</span>
              </li>
              <li className="flex gap-3 items-center">
                <FaPhoneAlt className="text-primary shrink-0" />
                <div className="flex flex-col gap-1">
                  <a href="tel:+919810070711" className="hover:text-primary transition-colors">+91 98100 70711</a>
                  <a href="tel:+919560647158" className="hover:text-primary transition-colors">+91 95606 47158</a>
                </div>
              </li>
              <li className="flex gap-3 items-center">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-white/50 font-sans">
          <p>
            Hindustan Buildwell &copy; 2026. All Rights Reserved.
          </p>
