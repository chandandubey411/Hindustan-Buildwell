  ...
  return (
    <div className="relative w-full bg-dark overflow-hidden font-heading">
      ...
      <PageHero
        ...
        subtitle="Discover the values, leadership, and milestones that make Hindustan Buildwell India's trusted real estate consultants — for over two decades."
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <SlideUp className="flex flex-col gap-6 text-left">
              ...
              <p className="text-white/70 text-sm font-sans font-light leading-relaxed">
                Hindustan Buildwell was founded with a single vision — to make premium real estate accessible, transparent, and rewarding for every Indian family. Starting from humble beginnings in Noida, we have grown into one of North India's most recognized real estate consultancies.
              </p>
              <p className="text-white/70 text-sm font-sans font-light leading-relaxed">
      ...
      <section className="relative py-20 border-t border-white/5">
        ...
        <div className="max-w-4xl mx-auto px-4 md:px-8 relative z-10 text-center flex flex-col items-center gap-6">
          ...
          <p className="text-white/60 text-sm font-sans font-light max-w-xl leading-relaxed">
            Join thousands of satisfied investors and homebuyers who trusted Hindustan Buildwell to secure their future.
          </p>
